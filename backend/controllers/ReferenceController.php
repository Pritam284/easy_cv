...
use backend\models\search\ReferenceSearch;
...
class ReferenceController extends Controller
{
    ...
    {
        $reference = Reference::find()->where(['user_id' => Yii::$app->user->id])->one();
    ...
    {
        if (($model = Reference::findOne(['user_id' => Yii::$app->user->id])) !== null) {
            return $model;
        }
